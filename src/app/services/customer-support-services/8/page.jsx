      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Ensuring every customer interaction meets the highest standards of
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your team works hard. We help make sure each part meets the
                  goal. Our quality team checks work with care and gives real
                  feedback. We spot gaps and help fix weak spots. Each task is
                  checked and scored. You get clear reports on what works and
                  what needs work. We aim to lift your team and keep your work
                  sharp. Let us help build a strong base for your growth.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We provide quality assurance solutions designed to elevate service standards, improve performance, and ensure consistency across every customer interaction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Supportive Help",
                body: "We do not just check. We guide your team with tips to do more.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Full Task Checks",
                body: "We check each step to keep your work clean and strong.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Clear Reports",
                body: "We send notes and fix tips to help your team grow fast.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
