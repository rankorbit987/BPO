      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Front Desk{" "}
            <span style={{ color: colors.accent }}>Support</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Creating positive first impressions through attentive and professional service.
          </p>
      ...
      <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Relaibale Front Desk{" "}
                  <span style={{ color: colors.primary }}>Support</span>
                </h2>
                <p
                  className="text-lg leading-relaxed mb-6"
                  style={{ color: colors.darkText }}
                >
                  First talks set the tone. Our front desk team gives a warm
                  welcome and smart help. We greet callers with care and guide
                  each one to the right place. From phone calls to client notes,
                  we keep it all in line. We make sure no task is missed. Your
                  day runs smoothly while we manage the front line. Our voice is
                  firm but kind. Each call gets full care. We help callers feel
                  safe and ready to trust your team. You get peace of mind while
                  we take care of each word and task.
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Warm First Hello",
                body: "We greet with heart. Each voice call starts with care and trust.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "We sound like your team. Our talk style fits your brand tone.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
