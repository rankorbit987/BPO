      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Empowering your business with reliable, personalized remote support
            that enhances productivity and streamlines daily operations.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your day is full. Let our virtual assistant help clear your
                  task list. We plan, track, and do each task with care. From
                  mail to calls, we handle the load with calm. Each job is done
                  on time with smart work. We keep notes, set dates, and send
                  alerts. Your time is free to grow your work. Our goal is to
                  help you do more with less stress. You stay in charge while we
                  do the rest.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We offer end-to-end support services that align with your operations and drive results.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "We manage your task list each day to stay on track with ease",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Each task is done fast. We waste no time and keep pace strongly.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
