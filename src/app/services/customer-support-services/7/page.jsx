    ...
    <div className="font-montserrat" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <div className="absolute top-5 left-8 w-full h-full opacity-10">
          <div className="absolute w-40 h-40 rounded-4xl" style={{ backgroundColor: colors.lightText }} />
          <div className="absolute bottom-10 right-10 w-60 h-60 rounded-4xl" style={{ backgroundColor: colors.lightText }} />
        </div>

        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Virtual Order{" "}<span style={{ color: colors.accent }}>Taker</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Turning customer requests into confirmed orders—quickly and efficiently.
          </p>
      ...
      <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6" style={{ color: colors.lightText }}>
                  Customer-Focused Order Taking{" "}
                  <span style={{ color: colors.primary }}>Services</span>
                </h2>
                <p className="text-lg leading-relaxed mb-6" style={{ color: colors.darkText }}>
                 Let us help your shop run fast. Our virtual order takers speak with care and guide each sale. We take the right details and confirm each step. From food to parts, we cover all types. Our team is fast and calm. No mix-ups, no missed steps. Your clients get a smooth path from call to close. Each order is clear and logged correctly. You get the sales. We handle the rest
                </p>
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative rounded-xl overflow-hidden shadow-2xl transform hover:scale-105 transition duration-500">
                ...
                >
                  <span className="text-white text-xl font-bold">Dedicated Support Team</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg max-w-3xl mx-auto" style={{ color: colors.darkText }}>
              Streamlining order management through reliable, 24/7 virtual support
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="p-6 flex flex-col h-full">
                  ...
                  <h3 className="text-xl font-bold mb-3" style={{ color: colors.lightText }}>{title}</h3>
                  <p className="flex-grow" style={{ color: colors.darkText }}>{body}</p>
                  <div className="mt-4">
