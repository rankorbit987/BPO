      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Scheduling with precision and professionalism to keep your business
            running smoothly.
          </p>
      ...
      <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your team needs time to grow. Let us handle the calls. We set
                  each talk at the right time. Our team speaks with care and
                  plans with skill. We book your days with a smart flow. Each
                  call turns into a clear plan. Clients feel safe and heard.
                  Your team stays free to work while we fill your time with real
                  leads. No mix-ups, no missed steps. Just clear talks and set
                  times. Our booking team works with focus and helps you stay on
                  track. Trust us to keep your calendar full and your stress
                  low.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              Why Choose{" "}
              <span style={{ color: colors.primary }}>Our Service</span>
            </h2>
            <p
              className="text-lg max-w-3xl mx-auto"
              style={{ color: colors.darkText }}
            >
              We provide Professional Appointment Booking Services tailored to your
              business needs.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "We match times with your team. No clashes, no mix-ups.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Lead Focused Plans",
                body: "We book with care. We aim to set talks that bring real value.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "We confirm each set of talks. Clients feel sure, and your day stays smooth.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
