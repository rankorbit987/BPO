      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Chat Support <span style={{ color: colors.accent }}>Services</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Providing real-time, personalized assistance that builds trust and
            loyalty—one message at a time.
          </p>
      ...
      <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Fast help keeps clients happy. Our live chat team gives real
                  help in real time. We answer quickly and stay calm. No bots,
                  just real people. Each word is clear. We fix the issue and
                  build trust with each chat. Your site stays live with a full
                  chat desk. We help with sales, support, and more. Each chat
                  gets a kind tone and full focus, so your clients get the help
                  they need while you stay free to work. Let our chat team boost
                  your service and build more trust each day.
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Fast Chat Help",
                body: "We reply in seconds. No wait time for your users.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Clear Word Flow",
                body: "Our team writes clean and short lines. Easy to read and follow.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "You get reports of all talks. Each word is saved and clear.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
