      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Inbound & Outbound{" "}
            <span style={{ color: colors.accent }}>Calling</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Building trust and loyalty through every inbound and outbound call—personalized, efficient, and customer-focused.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your business needs real support to grow. That means clear and
                  smooth communication that works every time. Our inbound and
                  outbound calling service gives you a simple way to stay in
                  touch with every client. We manage calls with care and always
                  aim to meet your goals. Each call helps your business move
                  forward. We speak with skill and stay calm in every talk. From
                  support to sales, we handle it all for you. Every call helps
                  build trust and keeps your team free to focus on work. With
                  us, your phone line becomes a smart tool.
                </p>
            ...
            {[
              {
                ...
                body: "We handle calls day and night. You never miss a chance to help your clients or close a deal.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Clear Voice Service",
                body: "We speak with care. Every word is easy to hear and free of errors.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Fast Call Handling",
                body: "No long wait for your clients. Our team picks up fast and responds with care.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
