      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Unlocking your website’s full potential through strategic testing
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your site may get views, but do they act? We help more users
                  take real steps. Our team checks your page to find gaps that
                  stop people from moving. We fix those spots. From layout to
                  buttons, we tune each part with care. With smart tools, we
                  test each fix and track gains. You get more leads and more
                  buys with the same views. This means better value from your
                  site. Let us shape your path and grow your goals.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We use data, user behavior analysis, and strategic testing to fine-tune your website and campaigns—maximizing conversion opportunities and improving your ROI at every step.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Page Flow Fix",
                body: "We shape each page step by step so the user moves with ease.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Smart Form Work",
                body: "We build short and clean forms that get filled fast with no drop rate.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "We cut page time so no one drops off while your page loads slowly.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
