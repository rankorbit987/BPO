      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Building brand awareness and customer loyalty through impactful
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  People spend more time on social apps each day. Your brand
                  must meet them there with value. We help you stay close to
                  fans and build trust. We post, plan, and reply for you with
                  care and focus. Each post is made to spark likes, shares, and
                  more talk. Your brand voice grows with every scroll. We keep
                  your feed live and your fans active. Our smart tools show what
                  works best and guide future posts. You get growth that feels
                  real and steady. Let us help you grow where your fans already
                  live.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We deliver platform-optimized strategies, engaging content, and
              performance analytics that help your brand stand out and connect
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Plan Made for You",
                body: "We build a full post plan that fits your goals and daily needs.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Trend Catching",
                body: "We track trends and use them in smart ways to grow your brand voice.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Fan Growth Help",
                body: "We help you gain real fans who like and trust your brand voice.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
