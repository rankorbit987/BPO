      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Helping you reach the right audience, at the right time, with
            measurable results.
          </p>
            ...
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  ...
                  match your brand. We guide clicks to your page and turn views
                  into real leads. Our team works to grow your name and keep
                  your plan on track. With us, you build trust and get real
                  gains.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We deliver full-spectrum digital marketing solutions tailored to
              your brand, goals, and audience—ensuring visibility, engagement,
