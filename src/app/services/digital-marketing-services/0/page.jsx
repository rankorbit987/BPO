      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            ...
            <span style={{ color: colors.accent }}>(SEO)</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Optimizing your digital presence to attract the right audience at
            the right time.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Want more views and real leads? Our SEO work helps push your
                  site up fast. We study what fans search and build pages that
                  match. From page speed to smart tags, we check it all. We
                  write clean text that search tools like. You get more views
                  and clicks that count. We work with your team to build strong
                  site steps. Each move is made to bring you growth.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We craft customized SEO strategies built on deep keyword research,
              technical expertise, and performance tracking—designed to improve
              your search visibility and drive meaningful results.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "We start with a deep scan to find gaps and fix them fast.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Smart Page Text",
                body: "We write text that fits what fans search. No waste, just smart use.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Rank Track Tools",
                body: "We show how your site grows and where to aim next.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
