      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            ...
            <span style={{ color: colors.accent }}>Services</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Maximizing every click with data-backed targeting and budget
            efficiency.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Precision-Driven PPC Campaigns for{" "}
                  <span style={{ color: colors.primary }}>Maximum Impact</span>
                </h2>
                <p
                  className="text-lg leading-relaxed mb-6"
                  style={{ color: colors.darkText }}
                >
                  You need the right clicks to win more leads. Our PPC work
                  helps you get them fast. We write ads that match what people
                  want and lead them to you. Each ad is tested and built with a
                  goal in mind. We adjust ads based on clicks and views, so no
                  spend is lost. You get full stats to see where your ads shine.
                  With our tools, you get more value from your spend. Let us
                  help you gain more clicks and grow each day.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We create and manage high-performing PPC campaigns that align with
              your goals, optimize ad spend, and deliver consistent, measurable
              business growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Smart Ad Setup",
                body: "We build ad sets that match your aim and grab the right crowd.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Clean Budget Use",
                body: "We keep your spend safe by cutting low clicks and boosting top wins.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Live Result Viewp",
                body: "We share live stats so you can see how your ads grow and shift.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
