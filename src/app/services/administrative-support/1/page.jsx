      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Automation <span style={{ color: colors.accent }}>Services</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Helping your business work faster, smarter, and with fewer manual
            errors.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Smart work beats hard work. Our automation tools help your
                  team save time and do more. We set up smart flows that run on
                  their own. You get alerts, updates, and clean data with no
                  extra steps. We help with tasks like form send, lead sort, and
                  client alerts. Each part of your work runs smoothly. We help
                  link apps and move data in real time. Let our team turn slow
                  work into fast wins.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We design, implement, and manage intelligent automation workflows
              that align with your business processes — reducing manual
              workload, improving accuracy, and freeing up your team to focus on
              growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Smart Flow Setup",
                body: "We build flows that fit your work. No guesswork, just clean plans",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Tool Link Help",
                body: "We join your apps to help data move smoothly from step to step.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Task Timer Save",
                body: "You cut time on each task. We help you do more in less time.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
