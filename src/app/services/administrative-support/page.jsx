...
export default function AdminstrativeSupport() {
  const colors = {
    primary: "#C93C3C",
    secondary: "#2C3E50",
    accent: "#E74C3C",
            ...
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  ...
                  <span style={{ color: colors.primary }}>Assistance</span>
                </h2>
                <p
                  className="text-lg leading-relaxed mb-6"
                  style={{ color: colors.darkText }}
                >
                  Our administrative services keep your operations smooth and
                  organized. From scheduling and data entry to managing
                  communications, we handle the details so you can focus on
                  growth. We work behind the scenes with precision, speed, and
                  care. Whether you're a startup or a growing enterprise, our
                  support scales with your needs. With us, your workflow stays
                  on track — organized, efficient, and stress-free.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We deliver dependable administrative support tailored to your
              business operations—freeing up your time, improving efficiency,
              and ensuring every detail is handled with care.
            </p>
          </div>
