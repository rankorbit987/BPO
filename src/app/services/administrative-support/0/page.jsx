      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            CRM Support <span style={{ color: colors.accent }}>Services</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Empowering your business with seamless CRM operations and smarter
            customer engagement.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Your team works best when tools work right. Our CRM support
                  team helps keep things on track. We manage data, solve issues,
                  and train your staff with care. From setup to daily use, we
                  handle it all. Each update is clean and quick. You stay
                  focused while we manage the flow. We help your team get the
                  most from each tool. No task is too small. Each step gets full
                  care. With us, your CRM runs smoothly and stays clear. You get
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We provide hands-on CRM expertise that aligns with your business
              needs — improving user adoption, boosting efficiency, and
              unlocking the full potential of your customer data. Our proactive
              support ensures your CRM grows with you.
            </p>
          </div>
