      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Chatbots & {" "}
            <span style={{ color: colors.accent }}>Intelligent Ticket Routing</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Automate support, boost response times, and route queries smarter.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  AI-Powered Virtual Assistants and {" "}
                ...
                >
                  We build AI chatbots and smart routing systems to handle inquiries instantly and direct tickets to the right teams. This speeds up resolutions, reduces manual work, and enhances customer satisfaction.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              Our AI-driven tools reduce support load, improve accuracy, and ensure every query is handled efficiently.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Deploy chatbots for instant, 24/7 support that handles FAQs and basic tasks.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Automatically assign tickets to the right team based on issue type or priority.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Integrate chatbots across web, mobile, and social to unify customer support.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
