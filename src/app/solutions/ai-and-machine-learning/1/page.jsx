      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Turn past data into future-ready insights that guide your strategy.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  We develop predictive models that help you forecast trends, customer behavior, and operational needs. Our solutions empower you to make proactive, data-backed decisions that boost performance.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We turn your raw data into clear, actionable insights so you can stay ahead of the curve and outpace competitors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Trend & Demand Forecasting",
                body: "Use historical and real-time data to anticipate sales, inventory, and market shifts.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Identify business risks and growth opportunities before they impact results.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
