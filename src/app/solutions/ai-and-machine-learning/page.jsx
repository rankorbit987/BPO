      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            AI and{" "}
            <span style={{ color: colors.accent }}>Machine Learning</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Harness AI and machine learning to automate, analyze, and optimize
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Advanced AI Solutions to Drive{" "}
                ...
                >
                  We develop AI-powered solutions that help businesses predict
                  trends, automate decisions, and improve efficiency. Our
                  machine learning models analyze data to uncover insights and
                  enable smarter strategies.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              Our AI expertise delivers smart, scalable solutions that transform
              data into actionable insights and streamline operations.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Tailored AI models to solve your specific business challenges.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Smart Chatbots & Ticket Routing",
                body: "AI chatbots and routing systems deliver instant support and faster issue resolution.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Models that forecast trends and customer behavior for smarter decisions.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
