...
export default function ComunicationCollaboration() {
  const colors = {
    primary: "#C93C3C",
    secondary: "#2C3E50",
    accent: "#E74C3C",
      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            ...
            <span style={{ color: colors.accent }}>Tools</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Connect your team, streamline workflows, and boost productivity.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  We implement unified communication tools and collaborative
                  platforms that enhance real-time interaction, file sharing,
                  and project coordination—keeping your team connected and
                  efficient.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We design collaboration ecosystems that break down silos, improve
              coordination, and support agile teamwork across departments or
              locations.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Integrate messaging, voice, and video tools to simplify internal and external communication.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Deploy platforms like Slack, Microsoft Teams, or Asana to centralize tasks and discussions.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Real-Time File Sharing & Sync",
                body: "Enable secure file access and updates across teams, improving speed and version control.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
