      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Centralize communication, tasks, and teamwork in one secure
            platform.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  We help businesses fully leverage Microsoft Teams by
                  integrating chat, video calls, file sharing, and task
                  management into one cohesive workspace—streamlining
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              Our solutions unlock the full potential of Microsoft Teams,
              driving smoother collaboration, better organization, and higher
              ROI from your Microsoft 365 environment.
            </p>
          </div>
