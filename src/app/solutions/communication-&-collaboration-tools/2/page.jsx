      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
           Zoom {" "}
            <span style={{ color: colors.accent }}>Integration</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Connect teams and clients with reliable, high-quality video communication.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Efficient Video Collaboration with {" "}
                ...
                >
                 We help businesses integrate Zoom for effortless video meetings, webinars, and team collaboration—enhancing communication, reducing friction, and supporting remote work.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We tailor Zoom solutions that boost engagement, simplify workflows, and deliver reliable performance for meetings and events of any size.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Zoom Setup & Custom Configuration",
                body: "We handle full Zoom setup, branding, and user configuration based on your business needs.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Integrate Zoom with calendars, CRMs, and collaboration tools like Microsoft Teams or Slack for streamlined scheduling and communication.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Webinar & Training Support",
                body: "Set up Zoom Webinars with automated registration, follow-ups, and analytics for professional virtual events.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
