      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          ...
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Empower fast, focused teamwork with real-time communication.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  We implement and customize Slack to enhance team communication, automate workflows, and integrate essential tools—creating a centralized, agile workspace that boosts productivity and collaboration.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We turn Slack into a powerful command center for your team—reducing email clutter, improving visibility, and accelerating daily operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-10">
            {[
              {
                title: "Slack Workspace Setup & Customization",
                body: "We structure channels, permissions, and settings to match your team’s workflow.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "App & Bot Integrations",
                body: "Connect Slack with tools like Google Workspace, Trello, and custom bots for automation and efficiency.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Connect Teams with tools like SharePoint, Power Automate, and third-party apps.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
