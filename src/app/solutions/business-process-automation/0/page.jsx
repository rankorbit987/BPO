        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            ...
            <span style={{ color: colors.accent }}>
              (Zapier, Monday.com, Power Automate)
            </span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Streamline operations. Save time. Eliminate manual work.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  We simplify your processes with automated workflows that
                  reduce errors, speed up execution, and free your team to focus
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We create smart, flexible automations tailored to your systems and goals—improving speed, accuracy, and efficiency across your operations.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "We design workflows that trigger actions automatically, cutting down manual effort and delays.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Connect tools like CRMs, Slack, and Google Workspace for smooth, end-to-end automation.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Track workflows in real time to resolve issues quickly and keep everything running efficiently.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
