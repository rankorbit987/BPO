      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Task Management &{" "}
            <span style={{ color: colors.accent }}>Orchestration</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Streamline task assignment, tracking, and execution with intelligent
            orchestration.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  Efficient Task Coordination and{" "}
                ...
                >
                  We help businesses automate task delegation and monitoring to
                  boost productivity and ensure timely project completion. Our
                  solutions prioritize, assign, and track tasks based on your
                  business rules, reducing delays and manual follow-ups.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We deliver smart task orchestration tailored to your needs,
              improving team efficiency and accountability while reducing manual
              oversight.{" "}
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Automatically assign tasks to the right team members based on skills and availability.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              {
                title: "Priority-Based Task Tracking",
                body: "Track task progress and deadlines in real-time to keep projects on schedule.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Coordinate complex task sequences to ensure smooth handoffs and timely execution.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
