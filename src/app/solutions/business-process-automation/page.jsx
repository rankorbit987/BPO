      ...
      >
        ...
        <div className="relative z-10 px-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            ...
            <span style={{ color: colors.accent }}>Solution</span>
          </h1>
          <p className="text-white text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Saving time and reducing errors with custom-built automation.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/3">
              <div className="mb-8">
                ...
                >
                  At BPO Brigade, we help businesses streamline operations by
                  automating repetitive tasks, reducing errors, and optimizing
                  workflows. Our tailored solutions enhance efficiency across
                  departments, giving your team more time to focus on strategic
                  growth. With the right tools and expertise, we turn complex
                  processes into seamless, scalable systems that drive real
                  results.
                </p>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: colors.darkText }}
            >
              We design smart, scalable automation that saves time, reduces
              errors, and boosts productivity. Our solutions align with your
              goals and integrate seamlessly into your existing systems.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Automate tasks and connect tools like Zapier or Power Automate to streamline operations and eliminate delays.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Auto-assign, track, and prioritize tasks for faster execution and better team coordination.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
              ...
              },
              {
                ...
                body: "Sync data across platforms to ensure accuracy, consistency, and real-time visibility.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
